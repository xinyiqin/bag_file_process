...
def fasternet_t0(weights=None, cfg=r'/home/cong/miniconda3/envs/openmmlab/lib/python3.8/site-packages/ultralytics/nn/backbone/faster_cfg/fasternet_t0.yaml'):
    with open(cfg) as f:
...
def fasternet_s(weights=None, cfg=r'/home/cong/miniconda3/envs/openmmlab/lib/python3.8/site-packages/ultralytics/nn/backbone/faster_cfg/fasternet_s.yaml'):
    with open(cfg) as f:
        cfg = yaml.load(f, Loader=yaml.SafeLoader)
    model = FasterNet(**cfg)
    if weights is not None:
